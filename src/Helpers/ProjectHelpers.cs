...
namespace HtmlTools
{
    internal static class ProjectHelpers
    {
        ...
        {
            IContentTypeRegistryService ctr = WebEditor.ExportProvider.GetExport<IContentTypeRegistryService>().Value;
        ...
        {
            ProjectItem file = GetProjectItem(relativeToFile);
        ...
        private static string ToAbsoluteFilePath(string relativeUrl, ProjectItem file)
        {
            ...
            string baseFolder = file.Properties == null ? null : ProjectHelpers.GetProjectFolder(file);
        ...
        public static string ToAbsoluteFilePath(string relativeUrl, string projectRoot, string baseFolder)
        {
            ...
            string root = (baseFolder ?? projectRoot).Replace(Path.AltDirectorySeparatorChar, Path.DirectorySeparatorChar);
        ...
        public static string FixAbsolutePath(string absolutePath)
        {
            ...
            string uniformlySeparated = absolutePath.Replace(Path.AltDirectorySeparatorChar, Path.DirectorySeparatorChar);
            string doubleSlash = new string(Path.DirectorySeparatorChar, 2);
            bool prependSeparator = uniformlySeparated.StartsWith(doubleSlash, StringComparison.Ordinal);
        ...
        public static ProjectItem AddFileToProject(string parentFileName, string fileName)
        {
            ...
            ProjectItem item = GetProjectItem(parentFileName);
            ...
            ProjectItem dependentItem = GetProjectItem(fileName);
